...
-- Wooh! 
local SimpleClassPower = CogWheel("LibModule"):NewModule("SimpleClassPower", "LibDB", "LibEvent", "LibUnitFrame", "LibStatusBar")
local Colors = CogWheel("LibDB"):GetDatabase("SimpleClassPower: Colors")
...
SimpleClassPower:RegisterSavedVariablesGlobal("SimpleClassPower_DB")
